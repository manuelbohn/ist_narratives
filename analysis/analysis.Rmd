...
ggsave("../visuals/fig5.png", width = 10, height = 6)
ggsave("../visuals/fig5.pdf", width = 10, height = 6)
...
ggsave("../visuals/fig6.png", width = 10, height = 6)
ggsave("../visuals/fig6.pdf", width = 10, height = 6)
...
ggsave("../visuals/fig7.png", width = 10, height = 6)
ggsave("../visuals/fig7.pdf", width = 10, height = 6)
```
...
```{r}
ggsave("../visuals/fig8.pdf", width = 10, height = 6)
ggsave("../visuals/fig8.png", width = 10, height = 6)
ggsave("../visuals/rq2_overview.pdf", width = 12, height = 8)
#ggsave("../visuals/rq2_overview.png", width = 12, height = 8)
```
